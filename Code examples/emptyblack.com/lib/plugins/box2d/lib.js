...
ig.module('plugins.box2d.lib').defines(function () {
    ...
    b2.Collision.CollidePolygons = function (b, c, d, e, f) {
        var g = b.pointCount = 0,
            h = [g],
            i = b2.Collision.FindMaxSeparation(h, c, d, e, f);
        g = h[0];
        if (!(i > 0)) {
            var j = 0;
            h = [j];
    ...
    b2.Distance.DistanceGeneric = function (b, c, d, e, f, g) {
        var h, i = b2.Distance.s_p1s,
            j = b2.Distance.s_p2s,
            k = b2.Distance.s_points,
            l = 0;
        b.SetV(d.GetFirstVertex(e));
        c.SetV(f.GetFirstVertex(g));
        for (var m = 0, n = 0; n < 1000; ++n) {
            h = c.x - b.x;
            var o = c.y - b.y,
                q = d.Support(e, h, o),
                r = f.Support(g, -h, -o);
    ...
    b2.TimeOfImpact.TimeOfImpact = function (b, c, d, e) {
        var f, g, h = b.m_sweepRadius,
            ...
            q = e.a - e.a0,
            r = 0,
            s = b2.TimeOfImpact.s_p1,
            v = b2.TimeOfImpact.s_p2,
            z = 0,
            y = g = 0,
            t = 0;
        for (f = 0;;) {
    ...
    b2.Contact.Create = function (b, c, d) {
        ...
        var e = b2.Contact.s_registers[b.m_type][c.m_type],
            f = e.createFcn;
    ...
    a.Update = function (b) {
        ...
        if (b.IsStatic() || b.IsBullet() || d.IsStatic() || d.IsBullet()) this.m_flags &= ~b2.Contact.e_slowFlag;
    ...
    b2.PolygonShape.ComputeOBB = function (b, c, d) {
        var e = 0,
            f = new Array(b2.Settings.maxPolygonVertices + 1);
    ...
    a.ComputeSweptAABB = function (b, c, d) {
        var e = b2.PolygonShape.s_sweptAABB1,
            f = b2.PolygonShape.s_sweptAABB2;
    ...
    a.SolveTOI = function (b) {
        var c = 0,
            d = new b2.ContactSolver(b, this.m_contacts, this.m_contactCount, this.m_allocator);
    ...
    a.Evaluate = function (b) {
        ...
        var i = [false, false],
            j = b2.PolyAndCircleContact.s_evalCP;
    ...
    a.SolveTOI = function (b) {
        var c, d, e, f = new b2.Island(this.m_bodyCount, b2.Settings.maxTOIContactsPerIsland, 0, this.m_stackAllocator, this.m_contactListener),
    ...
    a.DrawShape = function (b, c, d, e) {
        ...
        case b2.Shape.e_polygonShape:
            ...
            var h = b.GetVertexCount(),
                i = b.GetVertices(),
                j = new Array(b2.Settings.maxPolygonVertices);
    ...
    a.DrawDebugData = function () {
        if (this.m_debugDraw != null) {
            ...
            var b = this.m_debugDraw.GetFlags(),
                ...
                g = new b2.Vec2,
                h = new b2.Vec2,
                i = new b2.Color(0, 0, 0),
                j, k = new b2.AABB,
                l = new b2.AABB,
                m = [new b2.Vec2, new b2.Vec2, new b2.Vec2, new b2.Vec2];
            if (b & b2.DebugDraw.e_shapeBit) {
                ...
                for (d = this.m_bodyList; d; d = d.m_next) {
                    j = d.m_xf;
                    for (e = d.GetShapeList(); e; e = e.m_next) if (d.IsStatic()) this.DrawShape(e, j, new b2.Color(0.5, 0.9, 0.5), c);
                    else d.IsSleeping() ? this.DrawShape(e, j, new b2.Color(0.5, 0.5, 0.9), c) : this.DrawShape(e, j, new b2.Color(0.9, 0.9, 0.9), c)
                }
            }
