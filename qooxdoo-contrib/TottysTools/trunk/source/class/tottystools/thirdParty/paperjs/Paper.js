/*
Copy the entire paper.js file and put between the begin and the end comment.
It might be an error that is 0.; which you should change to 0.0;
*/

qx.Class.define('tottystools.thirdParty.paperjs.Paper', {
	...
	statics: {
		...
		paper: function(){
			...
			// end of paper code
			tottystools.thirdParty.paperjs.TottyInjectsPaper.inject(paper);
			this.__paper = paper;
